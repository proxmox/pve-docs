...
General the navigation are the same only some options are different.
...
* *Summary:* shows you important information about your storage like
'Usage', 'Type', 'Content', 'Active' and 'Enabled'.

* *Content:* Here all content will listed grouped by content type.
