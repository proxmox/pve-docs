...
{pve} can also use OCI images to create containers, both system containers but
also application containers. Note that running application containers in {pve}
...
include::generated/pct-mountpoint-opts.adoc[]
...
include::generated/pct-network-opts.adoc[]
...
include::generated/pct.conf.5-opts.adoc[]
