...
SMB protocol version. Optional, when set to `default` or when unset, negotiates
the highest SMB2+ version supported by both the client and server. SMB1 is not
