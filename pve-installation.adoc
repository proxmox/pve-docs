...
* Complete operating system (Debian Linux, 64-bit, "jessie" for {pve} 4.x)
* Partitioning of the hard drive(s) containing the OS with ext4, ext3, xfs or ZFS
* {pve} Kernel derived from Unbuntu 16.04 LTS with LXC and KVM support
